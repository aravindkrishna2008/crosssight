...
class Detections:
    ...
    def save(self, save_dir='vehicle_yolo/runs/detect/exp'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'vehicle_yolo/runs/detect/exp', mkdir=False)  # increment save_dir
        self.display(save=True, save_dir=save_dir)  # save results

    def crop(self, save_dir='vehicle_yolo/runs/detect/exp'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'vehicle_yolo/runs/detect/exp', mkdir=False)  # increment save_dir
